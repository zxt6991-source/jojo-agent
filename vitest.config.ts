...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@desktop-agent/server-protocol': path.resolve('packages/server-protocol/src/index.ts'),
      '@desktop-agent/server-core': path.resolve('packages/server-core/src/index.ts'),
      '@desktop-agent/server-http': path.resolve('packages/server-http/src/index.ts'),
      '@desktop-agent/client': path.resolve('packages/client/src/index.ts'),
