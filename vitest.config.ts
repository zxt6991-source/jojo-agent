...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@desktop-agent/agent-runtime/public': path.resolve('packages/agent-runtime/src/public/index.ts'),
      '@desktop-agent/agent-runtime/compat': path.resolve('packages/agent-runtime/src/harness/runner.ts'),
      '@desktop-agent/agent-runtime/memory': path.resolve('packages/agent-runtime/src/memory/runtime.ts'),
      '@desktop-agent/agent-runtime/store': path.resolve('packages/agent-runtime/src/storage.ts'),
      '@desktop-agent/agent-runtime/context': path.resolve('packages/agent-runtime/src/context.ts'),
